...
<body>
    ...
    <section class="hero" style="background-image: linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url('https://media.istockphoto.com/id/1282546631/es/foto/tiro-de-cerca-de-maquillaje-permanente-para-los-ojos-cosmet%C3%B3logo-aplicando-tatuajes-de-los.webp?a=1&b=1&s=612x612&w=0&k=20&c=FsGf0PeorVsaQElDmoZZ3R4qc1HWOnJcpNpozKKc-nM=');">
        <div class="hero-text animate-fade-in">
            <h1>Micropigmentación</h1>
            <p class="subtitle">Belleza Semipermanente</p>
            <p class="services-list">
                Cejas · Delineado de Ojos · Labios
            </p>
            <a href="#servicios-micorp" class="cta-btn">Ver Servicios</a>
        </div>
    </section>

    <section class="about">
      <div class="about-content">
        <h2 class="section-title animate-slide-up">Arte y Precisión</h2>
        <div class="about-grid" style="grid-template-columns: 1fr;">
          <div class="about-card visible">
            <div class="about-icon">✒️</div>
            <h3>Resultados Naturales</h3>
            <p>
              La micropigmentación es el arte de embellecer tus rasgos de forma duradera. Utilizamos pigmentos orgánicos de la más alta calidad y técnicas avanzadas para lograr un aspecto natural que resalte tu belleza sin parecer artificial. Olvídate del maquillaje diario.
            </p>
          </div>
        </div>
      </div>
    ...
    <section id="servicios-micorp" class="services">
        ...
        <div style="text-align: center; margin-top: 4rem;">
            <a href="https://wa.me/15123649251?text=Hola me gustaria agendar una cita para micropigmentacion" class="cta-btn" target="_blank">Agendar Cita</a>
        </div>
    </section>
    ...
    <section id="contacto" class="contact">
        ...
        <div class="contact-container">
            ...
            <div class="contact-info animate-fade-in">
                ...
                <p>
                    <a href="https://wa.me/15123649251?text=Hola me gustaria obtener mas informacion sobre micropigmentacion!!" 
                    target="_blank" 
